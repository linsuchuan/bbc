...
class topwap_site_view_helper {
    ...
    public function function_footer($params, $template)
    {
        ...
        return '<section class="section-white shopex-content-padded system-container"> <div class="system-type"> <a href="#" class="shopex-btn shopex-btn-warning shopex-btn-outlined btn-action-outlined">电脑版</a> </div> <div class="system-info">'.$foot.'</div> </section>';
    }
