...
class sysshop_api_demo_createShop {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'shop_descript'         => ['type'=>'string','valid'=>'required','description'=>'店铺详情','default'=>'','example'=>'专卖onex产品'],
            ...
            'shopuser_name'         => ['type'=>'string','valid'=>'','description'=>'店主姓名','default'=>'','example'=>'张三'],
            ...
            'shop_addr'             => ['type'=>'string','valid'=>'','description'=>'店铺地址','default'=>'','example'=>'桂林路396号2号楼'],
            'mobile'                => ['type'=>'string','valid'=>'','description'=>'店主手机号','default'=>'','example'=>'13312341234'],
            'email'                 => ['type'=>'string','valid'=>'','description'=>'店主邮箱','default'=>'','example'=>'1234@qq.com'],
            'login_account'         => ['type'=>'string','valid'=>'required','description'=>'店主账号','default'=>'','example'=>'demo'],
    ...
    public function create($params)
    {
        ...
        try{
            ...
            $shopInfo = [
                ...
                'seller_id' => 0,
                'open_time' => time(),
                'shop_descript' => $params['shop_descript'],
                'shop_logo' => $params['shop_logo'] ? : $default_img,
                'shopuser_name' => $params['shopuser_name'],
                'shopuser_identity' => $params['shopuser_identity'],
